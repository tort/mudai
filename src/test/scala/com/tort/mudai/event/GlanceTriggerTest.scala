...
class GlanceTriggerTest extends FunSuite with ShouldMatchers {
  ...
  val digging = "\u001B[1;36mПо полям\u001B[0;37m\n" +
    "  Даже Вы, не разбирающийся в земледелии, видите, что земля тут плохая,\n" +
    "почти песок и местные жители горбатится на полях от зари до заката, чтобы\n" +
    "прокормить свою семью. Более того, примыкающие с юга болота постоянно\n" +
    "увлажняют почву, закисляя ее. Ячмень здесь растет из-за этого плохо.\n" +
    "\n" +
    "\u001B[0;36m[ Exits: e w ]\u001B[0;37m\n" +
    "\u001B[0;33mЗдесь выкопана ямка глубиной примерно в 6 аршинов.\u001B[0;37m\n" +
    "\u001B[1;37mСнежный ковер лежит у вас под ногами.\u001B[0;37m\n" +
    "\u001B[1;33m\u001B[1;31m*Гридень ростовской дружины стоит здесь. \n" +
    " ..воздушная аура \n" +
    "\u001B[0;0m\n" +
    "\u001B[0;32m570H\u001B[0;37m \u001B[0;32m244M\u001B[0;37m 13778784о Зауч:0 26L 2235G Вых:ВЗ> "
